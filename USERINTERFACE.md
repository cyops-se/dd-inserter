...
The dashboard is empty from the beginning, but will show basic information about received OPC data. If an ```dd-opcda``` is already up and running and at least UDP port 4357 (default) is open in the local host firewall, there should be 
